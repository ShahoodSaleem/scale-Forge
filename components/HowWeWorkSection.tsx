...
export default function HowWeWorkSection() {
  return (
    <section className="bg-[#050505] py-24 px-6 md:px-12 w-full overflow-hidden relative">
      <div className="max-w-[1450px] mx-auto flex flex-col gap-16 item-center">
        ...
        <div className="w-full flex md:flex-row flex-col justify-between items-end gap-6 z-10">
          ...
          <motion.p
            ...
            className="text-white-400 text-base md:text-lg leading-relaxed max-w-md pb-2"
          >
        ...
        <div className="w-full overflow-x-auto pb-12 pt-8 hide-scrollbar flex justify-start xl:justify-center">
          {/* Main Diagram Container */}
          <div className="min-w-[1000px] flex items-center justify-start xl:justify-center relative select-none">
